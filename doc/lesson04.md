...
- Поправил `UserServiceTest.delete()`. В прежней реализации если `service.delete()` бросает `NotFoundException`, тест проходит.
...
> - [BETWEEN CONDITION](http://www.techonthenet.com/postgresql/between.php) нам больше не подходит, тк он включает граничные значения.
...
> - Вынес общий код матчеров в `TestMatcher<T>`. 
> - Для удобства сделал статический метод генерации `of`. См. Блох Джошуа, "Java. Эффективное программирование."
